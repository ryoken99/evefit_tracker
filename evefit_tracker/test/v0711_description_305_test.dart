...
void main() {
  group('v0.8.0 beginner-readable descriptions for catalog entries', () {
    test('all catalog entries have complete individual explanation fields', () {
      final entries = ExerciseCatalogContextService.entries;
      expect(entries.length, greaterThan(353));
