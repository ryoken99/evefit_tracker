...
void main() {
  ...
  test('canonical identity is separate from catalog entry identity', () {
    ...
    expect(technicalStandUp.catalogEntryKey, isNot(technicalStandUp.canonicalId));
  ...
  test('catalog refresh backfills canonical identity without changing history', () async {
