...
class TrainingFlow {
  ...
  static TrainingSelection _cardioSelection(TrainingFlowSelection flow) {
    ...
    return switch (modeKey) {
      ...
      'rower' => const TrainingSelection(
        regionKey: 'cardio',
        groupKey: 'cardio_machine',
        subgroupKey: 'rower',
        equipmentKey: 'rower',
      ),
      'stepper' || 'stairs' => const TrainingSelection(
        regionKey: 'cardio',
        groupKey: 'cardio_machine',
        subgroupKey: 'stepper',
        equipmentKey: 'stepper',
      ),
      'air_bike' => const TrainingSelection(
        regionKey: 'cardio',
        groupKey: 'cardio_machine',
        subgroupKey: 'air_bike',
        equipmentKey: 'air_bike',
      ),
