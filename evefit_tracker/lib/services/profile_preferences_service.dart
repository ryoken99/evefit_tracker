  ...
  static const equipmentSections = [
    ProfileSetupSection<ProfileEquipmentOption>(
      ...
      options: [
        ...
        ProfileEquipmentOption(key: 'water_bottles', name: 'Garrafas de água'),
        ProfileEquipmentOption(key: 'water_jug', name: 'Garrafão de água'),
        ProfileEquipmentOption(
          key: 'stable_step',
          name: 'Degrau / escada estável',
        ),
        ProfileEquipmentOption(key: 'sturdy_table', name: 'Mesa resistente'),
        ProfileEquipmentOption(key: 'broomstick', name: 'Cabo de vassoura'),
